...
public class StatsRectangle extends JPanel {
	...
	public void drawRect(Graphics g, int yLevel, ArrayList<String> allItems) {
		...
		g.fillRect(LEFT_EDGE, yLevel, (int) (BAR_LENGTH * protein), 50);

		g.setColor(new Color(193, 219, 155));
		g.fillRect(LEFT_EDGE + (int) (BAR_LENGTH * protein), yLevel, (int) (BAR_LENGTH * vegetable), 50);
		...
		g.fillRect(
				...
				yLevel, (int) (BAR_LENGTH * fruit), 50);
		g.setColor(new Color(207, 219, 231));
		g.fillRect(LEFT_EDGE + (int) (BAR_LENGTH * protein) + (int) (BAR_LENGTH * vegetable)
				+ (int) (BAR_LENGTH * grain) + (int) (BAR_LENGTH * fruit), yLevel, (int) (BAR_LENGTH * dairy), 50);
