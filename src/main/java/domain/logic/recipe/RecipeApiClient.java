...
public class RecipeApiClient {
	...
	public static List<Recipe> findRecipesByIngredients(String ingredients, int numberOfRecipes) {
		String urlString = String.format(
				"https://api.spoonacular.com/recipes/findByIngredients?ingredients=%s&number=%d&apiKey=%s", ingredients,
				numberOfRecipes, apiKey);
	...
	public static Map<Integer, String> getRecipeInstructions(int recipeId) {
		String urlString = String.format(
				"https://api.spoonacular.com/recipes/%d/analyzedInstructions?stepBreakdown=true&apiKey=%s", recipeId,
				apiKey);
