...
/**
 * Represents a recipe with an ID, title, image URL, and lists of used and
 * missed ingredients.
 */
public class Recipe {
	private int id;
	 ...
	 * The method does not fetch the instructions until this method is called, to
	...
	public String toString() {
		return "Recipe{" + "id=" + id + ", title='" + title + '\'' + ", image='" + image + '\'' + ", usedIngredients="
				+ usedIngredients + ", missedIngredients=" + missedIngredients + '}';
	}
}
