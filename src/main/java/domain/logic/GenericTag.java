 ...
 *
 * @param <T> the type of the tag (either {@code FoodFreshness} or
 *            {@code FoodGroup}), extending the Tag interface.
 */
public class GenericTag<T extends Tag> implements Comparable {
	 ...
	 * @return true if this GenericTag is the same as the obj argument; false
	 *         otherwise.
	 */
	@Override
	...
	public static <T extends Enum<T> & Tag> GenericTag<T> fromString(Class<T> enumType, String displayName) {
		...
		throw new IllegalArgumentException(
				"No enum constant with display name " + displayName + " found in " + enumType.getSimpleName());
	}
