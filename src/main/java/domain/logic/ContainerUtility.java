...
/**
 * Utility class for operations related to containers in the inventory DB
 * system. This includes adding, deleting, editing, and initializing containers.
 */
public class ContainerUtility {
	...
	/**
	 * Initializes the container buttons and associates them with their respective
	 * container objects upon application startup. It retrieves all container names
	 * from the database and adds them to the container map.
	 *
