...
public class Notification extends JFrame {
	...
	private void displayExpiringItemsNotification() {
		...
		if (!expiringItems.isEmpty()) {
			...
			JOptionPane.showMessageDialog(HomeView.getFrame(), message.toString(), "Expiring Items Alert",
					JOptionPane.WARNING_MESSAGE);
		} else {

			JOptionPane.showMessageDialog(HomeView.getFrame(), "No expiring items found.", "Expiring Items Alert",
					JOptionPane.INFORMATION_MESSAGE); // If there are no expiring item
		}
	}
