...
public class CalendarView {
	...
	/**
	 * Holds JLabel Month, JButton Previous, JButton Current, JButton Next, JButton
	 * Exit
	 */
	 ...
	 * Days of the week
	 */
	private String[] daysOfTheWeek = { "     Sunday", "     Monday", "    Tuesday", "   Wednesday", "    Thursday",
			"       Friday", "    Saturday" };

	/**
	 * Months of the year
	 */
	private String[] monthsOfTheYear = { "January", "February", "March", "April", "May", "June", "July", "August",
	...
	/**
	 * Adds action listeners to buttons, Exit uses containerView and HomeView
	 * 
	...
	/**
	 * Calculates the items that are apart of the Calendar month and returns a list
	 * of them
	 * 
	 * @param current The calendar month the list should be about
	 * @return A hasmap of the integer date and arraylist of items that expire on
	 *         that date
	 */
	...
	/**
	 * Checks if the day given and the calendar is the same as the actual current
	 * date
	 * 
