...
class IngredientTest {
	...
	void testIngredientCreationAndGetters() {
		Ingredient ingredient = new Ingredient(1, "Tomato", 2.5, "kg", "http://example.com/tomato.png",
				"2.5 kg of Tomatoes");
	...
	@Test
	void testEquals() {
		Ingredient ingredient1 = new Ingredient(1, "Tomato", 2.5, "kg", "http://example.com/tomato.png",
				"2.5 kg of Tomatoes");
		Ingredient ingredient2 = new Ingredient(1, "Potato", 3.0, "pcs", "http://example.com/potato.png",
				"3 pcs of Potatoes");
