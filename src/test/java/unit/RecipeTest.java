...
class RecipeTest {
	...
	void setUp() {
		...
		missedIngredient = new Ingredient(2, "Potato", 3.0, "pcs", "http://example.com/potato.png",
				"3 pcs of Potatoes");
	...
	void testAddAndSetIngredients() {
		...
		Ingredient newUsedIngredient = new Ingredient(3, "Carrot", 1.0, "kg", "http://example.com/carrot.png",
				"1 kg of Carrots");
		Ingredient newMissedIngredient = new Ingredient(4, "Onion", 2, "pcs", "http://example.com/onion.png",
				"2 pcs of Onions");
		...
		List<Ingredient> newUsedIngredients = List
				.of(new Ingredient(5, "Pepper", 0.5, "kg", "http://example.com/pepper.png", "0.5 kg of Pepper"));
		List<Ingredient> newMissedIngredients = List
				.of(new Ingredient(6, "Salt", 0.1, "kg", "http://example.com/salt.png", "0.1 kg of Salt"));
